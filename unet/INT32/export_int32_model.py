...
def process_conv(conv, layer_name, scale_in, activation_ranges):
    ...
    q_bias = quantize_tensor(b_float, scale_bias, zp_bias, dtype=torch.int64) # Biases to int64
...
def main(quantize_target):
    ...
    # --- ENCODER ---
    int32_state["e11"], s = process_conv(model.e11, "e11", scale_in, activation_ranges)
    int32_state["e12"], s = process_conv(model.e12, "e12", s, activation_ranges)
    int32_state["e21"], s = process_conv(model.e21, "e21", s, activation_ranges)
    int32_state["e22"], s = process_conv(model.e22, "e22", s, activation_ranges)
    int32_state["e31"], s = process_conv(model.e31, "e31", s, activation_ranges)
    int32_state["e32"], s = process_conv(model.e32, "e32", s, activation_ranges)
    int32_state["e41"], s = process_conv(model.e41, "e41", s, activation_ranges)
    int32_state["e42"], s = process_conv(model.e42, "e42", s, activation_ranges)
    int32_state["e51"], s = process_conv(model.e51, "e51", s, activation_ranges)
    int32_state["e52"], s = process_conv(model.e52, "e52", s, activation_ranges)

    # --- DECODER ---
    int32_state["upconv1"], s_up = process_conv(model.upconv1, "upconv1", s, activation_ranges)
    int32_state["d11"], s = process_conv(model.d11, "d11", activation_ranges["d11"]["in_scale"], activation_ranges)
    int32_state["d12"], s = process_conv(model.d12, "d12", s, activation_ranges)

    int32_state["upconv2"], s_up = process_conv(model.upconv2, "upconv2", s, activation_ranges)
    int32_state["d21"], s = process_conv(model.d21, "d21", activation_ranges["d21"]["in_scale"], activation_ranges)
    int32_state["d22"], s = process_conv(model.d22, "d22", s, activation_ranges)

    int32_state["upconv3"], s_up = process_conv(model.upconv3, "upconv3", s, activation_ranges)
    int32_state["d31"], s = process_conv(model.d31, "d31", activation_ranges["d31"]["in_scale"], activation_ranges)
    int32_state["d32"], s = process_conv(model.d32, "d32", s, activation_ranges)

    int32_state["upconv4"], s_up = process_conv(model.upconv4, "upconv4", s, activation_ranges)
    int32_state["d41"], s = process_conv(model.d41, "d41", activation_ranges["d41"]["in_scale"], activation_ranges)
    int32_state["d42"], s = process_conv(model.d42, "d42", s, activation_ranges)

    # --- OUTPUT LAYER ---
    int32_state["outconv"], _ = process_conv(model.outconv, "outconv", s, activation_ranges)

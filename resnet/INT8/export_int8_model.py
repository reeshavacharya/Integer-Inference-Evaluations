...
def main(model_path):
    ...
    int8_state["conv1"], s_out = process_conv(model.conv1, model.bn1, "conv1_relu", scale_in)
    ...
    out_path = os.path.join(RESNET_DIR, os.path.basename(model_path).replace(".pth", "_int8.pth"))

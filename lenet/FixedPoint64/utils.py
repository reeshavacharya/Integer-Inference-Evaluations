...
def execute_and_shift_linear(q_x, q_w, f_bits=F_BITS):
    ...
    # Because we truncated BEFORE multiplying, the post-multiplication remainder is technically 0.
    # The precision was dropped during the q_x_trunc and q_w_trunc steps instead.
    max_remainder = 0 
    # -----------------------------
...
def add_bias(q_accum, q_bias):
    """Adds the Q31.32 bias to the Q31.32 accumulator."""
